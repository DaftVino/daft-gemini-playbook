...
```text
Act as a fixture. Using @Source A and @Source B, draft a notice with the columns Item, Value,
Source, Owner, capping the output at five rows and marking anything unsupported as "Insufficient
